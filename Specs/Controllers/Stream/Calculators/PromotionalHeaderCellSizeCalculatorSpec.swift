        ...
        describe("PromotionalHeaderCellSizeCalculator") {
            describe("should size according to frame width") {
                ...
                it("should use minHeight") {
                    ...
                    let pageHeader: PageHeader = stub(["kind": PageHeader.Kind.category])
                    pageHeader.body = "Short body."
                    pageHeader.ctaCaption = "Read More"
